  ...
  const projects = [
    {
      ...
      images: [
        {
          src: "/projects/timely-dashboard.png",
          alt: "Dashboard do Timely com resumo de agendamentos",
          caption: "Dashboard com visão diária e indicadores de agendamentos.",
        },
        {
          src: "/projects/timely-agenda.png",
          alt: "Agenda do Timely com detalhes de um agendamento",
          caption: "Agenda visual e detalhes do atendimento em contexto.",
        },
      ],
      ...
      challenge:
        "Centralizar a operação de pequenos negócios que trabalham com horários, reduzindo o uso de agendas dispersas e tornando o acompanhamento da equipe mais simples.",
    ...
    },
    {
      ...
      images: [
        {
          src: "/projects/traxion-login.png",
          alt: "Tela de acesso do sistema Traxion",
          caption: "Acesso ao Traxion e apresentação dos pilares do produto.",
        },
      ],
      linkedin,
      role: "Produto e desenvolvimento full stack",
      challenge:
        "Organizar informações de frota que normalmente ficam espalhadas entre planilhas e processos manuais, criando uma base confiável para decisões operacionais.",
    ...
    },
    {
      ...
      challenge:
        "Estruturar um fluxo administrativo com múltiplas entidades, garantindo navegação protegida e uma API organizada para evoluir o produto.",
    ...
    },
    {
      ...
      images: [
        {
          src: "/projects/tema-producao-dashboard.png",
          alt: "Dashboard do Tema Produção com indicadores e gráfico de produções iniciadas",
          caption:
            "Indicadores carregados do backend e evolução diária das produções iniciadas.",
        },
      ],
      github: "https://github.com/victoramaraldev/tema-producao",
      role: "Desenvolvimento full stack",
      challenge:
        "Conectar uma interface moderna a uma fonte Firebird e apresentar indicadores operacionais densos de maneira objetiva.",
      resultTitle: "Entrega técnica",
      result:
