...
export const usePortfolioStore = defineStore('portfolio', () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      resultTitle: 'Entrega técnica',
      result: 'Solução desacoplada com dashboard Vue, Pinia, Vuetify e ApexCharts, apoiada por uma API NestJS responsável pela integração com o banco Firebird.',
      features: ['Indicadores operacionais', 'Gráficos de produção', 'API NestJS', 'Integração Firebird'],
    },
  ]
